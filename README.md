...
```
npm create cloudflare@latest -- --template=cloudflare/templates/nameless-butterfly-7cf3
```

## Preview Deployment

A live public deployment of this template is available at [https://nameless-butterfly-7cf3.templates.workers.dev](https://nameless-butterfly-7cf3.templates.workers.dev)
